...
export interface ExtensionOptions {
    // The most critical extension, this is the transport for secret management. (not all keystores will have direct access to the key material, maintaining non-exportability)
    keystore?: boolean | null | any // allow for any, this allows overriding of the options downstream. This could evolve to a dedicated type for keystore options
    // Accounts, the most common form of key material. These MUST provide TransactionSigners that are baked into the current Provider Context
    accounts?: boolean | null | any // Allow for any, this allows overriding of the options downstream. This could evolve to a dedicated type for accounts options
